...
uint16_t blockColors[] = {BLUE, GREEN, RED, YELLOW, WHITE, LIGHTBLUE, DARKGREY, ACCENT};
...
void drawTopTab() {
    ...
    int16_t x1, y1;
    uint16_t w, h;
    tft.getTextBounds("CapyStack", 0, 0, &x1, &y1, &w, &h);
...
void runDrawApp() {
    // ---- Place your Draw App setup and loop code here ----

    void runDrawApp() {
    // ---- Place your Draw App setup and loop code here ----
    // Draw a "Home" button at the bottom of the screen:
    int homeBtnX = (TFT_WIDTH - 100)/2, homeBtnY = TFT_HEIGHT-50;
    tft.fillRoundRect(homeBtnX, homeBtnY, 100, 40, 12, LIGHTBLUE);
    tft.drawRoundRect(homeBtnX, homeBtnY, 100, 40, 12, ACCENT);
    tft.setCursor(homeBtnX + 20, homeBtnY + 12); tft.setTextColor(ACCENT); tft.setTextSize(2); tft.print("Home");

    // ---- In your draw app loop, check for touch on home button and if pressed:
...
// ---- TicTacToe Skeleton ----
void runTicTacToe() {
    // ---- Place your TicTacToe setup and loop code here ----
    #include <Arduino.h>
#include "Adafruit_GFX.h"
#include "MCUFRIEND_kbv.h"
#include "TouchScreen.h"
...
void loop() {
    ...
    // ---- In your tictactoe loop, check for touch on home button and if pressed:
    // currentScreen = HOME; return;
    currentScreen = HOME;
return;
}
...
void setup() {
 ...
 // ... other home screen touch logic ...
        ...
        case TICTACTOE:
            ...
            drawHomeScreen();
            break;
        // ... other cases (existing tetris, highscores, etc) ...
        default:
            // ... existing logic ...
            break;
    }
